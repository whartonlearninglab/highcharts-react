  ...
  _createClass(HighchartsReact, [{
    ...
    value: function componentDidMount() {
      var _props = this.props,
          highcharts = _props.highcharts,
          constructorType = _props.constructorType,
    ...
    value: function componentDidUpdate() {
      ...
      if (props.allowChartUpdate !== false) {
        ...
        (_chart = this.chart).update.apply(_chart, [props.options].concat(_toConsumableArray(props.updateArgs)));
      }
    }
  }, {
    ...
    key: 'setContainer',
    value: function setContainer(div) {
      this.container = div;
    }
  }, {
    key: 'render',
...
HighchartsReact.propTypes = {
  highcharts: _propTypes2.default.object,
  constructorType: _propTypes2.default.string,
  options: _propTypes2.default.object,
  callback: _propTypes2.default.func,
  allowChartUpdate: _propTypes2.default.bool,
  updateArgs: _propTypes2.default.array
};
